...
public:
    ...
    Computer(CPU & cpu,VideoCard & videoCard,Memory & memory)
      :m_cpu(cpu),m_vc(videoCard),m_m(memory){}
...
int main(){
    ...
    //组装第一台电脑
    cout<<"第一台电脑："<<endl;
    Computer c1 =Computer(interCPU,interVideoCard,interMemory);
    c1.work();
    //delete c1;
    ...
    LenovoCPU lenovoCPU;
    // 创建显卡
    LenovoVideoCard lenovoVideoCard;
    // 创建内存条
    LenovoMemory lenovoMemory;

    Computer  c2 =  Computer(lenovoCPU,lenovoVideoCard,lenovoMemory);
    c2.work();
    //delete c2;
    cout<<"===================="<<endl;
    cout<<"第三台电脑："<<endl;

    //  Computer  c3 = Computer(InterCPU,InterVideoCard,LenovoMemory);
    //  c3->work();
    // delete c3;
