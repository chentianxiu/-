...
#include "../../Clientmeeting/addfrienddialog.h"
...
QT_MOC_LITERAL(4, 36, 21), // "on_addName_PB_clicked"
QT_MOC_LITERAL(5, 58, 23), // "on_moveRight_PB_clicked"
QT_MOC_LITERAL(6, 82, 22), // "on_moveLeft_PB_clicked"
QT_MOC_LITERAL(7, 105, 21) // "on_buttonBox_accepted"

    },
    "addfriendDialog\0addfriends\0\0friends\0"
    "on_addName_PB_clicked\0on_moveRight_PB_clicked\0"
...
void addfriendDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_addName_PB_clicked(); break;
        case 2: _t->on_moveRight_PB_clicked(); break;
        case 3: _t->on_moveLeft_PB_clicked(); break;
        ...
        {
            using _t = void (addfriendDialog::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addfriendDialog::addfriends)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void addfriendDialog::addfriends(QStringList _t1)
{
