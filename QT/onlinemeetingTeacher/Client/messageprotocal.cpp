...
QStringList messageProtocal::getListValue(QString Key)
{
...
void messageProtocal::addValue(QString key, QStringList values)
{
    QJsonArray array;
...
void messageProtocal::sendMsg(QTcpSocket *socket)
{
...
void messageProtocal::recvMsg(QTcpSocket *socket)
{
    //先读取长度，保证不会多读
    int len = 0;
